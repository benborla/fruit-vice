<template>
  <div class="border-top py-3 d-flex justify-content-between align-items-center">
    <section>
      <Refs /> <a href="https://benborla.dev" class="text-decoration-none" title="https://benborla.dev">Ben Borla</a>
      <a href="https://github.com/benborla/fruit-vice" class="text-decoration-none ms-1"
